...
def create_application(row: dict) -> dict:
    ...
    Website applications receive an application confirmation email.
    Gmail-imported applications do not receive an automatic
    confirmation email.
    """
    ...
    #
    # IMPORTANT:
    # Website applications are allowed to receive the
    # confirmation email.
    #
    # Gmail-imported applications have source="EMAIL".
    # We intentionally DO NOT send an automatic email for
    # those applications.
    # ---------------------------------------------------------

    if created.get("source") != "EMAIL":
        ...
        logger.info(
            "Skipping application confirmation email for "
            "Gmail-imported application %s",
            application_id,
        )
